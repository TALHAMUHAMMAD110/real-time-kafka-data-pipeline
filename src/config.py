...
KAFKA_INPUT_TOPIC = os.getenv("KAFKA_INPUT_TOPIC", "user_events")

# POSTGRES CONFIG
POSTGRES_USER = os.getenv("POSTGRES_USER")
POSTGRES_PASSWORD = os.getenv("POSTGRES_PASSWORD")
POSTGRES_DB = os.getenv("POSTGRES_DB", "lottery_db")
POSTGRES_URL = os.getenv("POSTGRES_URL", f"jdbc:postgresql://postgres:5432/{POSTGRES_DB}")
POSTGRES_TABLE = os.getenv("POSTGRES_TABLE", "lottery_aggregates")
